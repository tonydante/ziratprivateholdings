	...
	"<div class='navbar-header'>" +
		"<div class='col-lg-2 col-md-2 col-sm-3'>" +
			"<button type='button' class='navbar-toggle collapsed hidden' data-toggle='collapse' data-target='#navbar' aria-expanded='false' aria-controls='navbar'>" +
				...
				"<span class='icon-bar'></span> " +
			"</button>" +
			"<a class='navbar-brand' href='index.html'><img src='img/logo.png' data-rjs='img/logo@2x.png' alt='Ziraat  credit union'></a>" +
		"</div>" +
		...
		"<ul class='nav navbar-nav'>" +
			...
			"<li class='dropdown'>" +
				...
				"<ul class='dropdown-menu'>" +
					...
					"<li><a href='kisaca.html'>Kısaca Ziraat  credit union</a></li><li><a href='kuresel-hizmetagi.html'>Küresel Hizmet Ağımız</a></li>" +
					...
					"<li class='dropdown dropdown-submenu'><a href='#' class='dropdown-toggle' data-toggle='dropdown'>Güçlü Köklerimiz, Sağlam Ortaklık Yapımız</a>" +
						"<ul class='dropdown-menu'>" +
							...
							"<!--li><a href='misyonvizyon.html#ortaklikyapisi'>Ziraat  credit union Ortaklık Yapısı</a></li-->" +
			...
			"<li class='dropdown'>" +
				...
				"<ul class='dropdown-menu'>" +
					...
					"<li><a href='ZRTSRDT2015.pdf' target='_blank'>Ziraat  credit union 2015 Sürdürülebilirlik Raporu <i class='fa fa-file-pdf-o' aria-hidden='true'></i></a></li>" +
				"</ul>" +
			"</li>" +
